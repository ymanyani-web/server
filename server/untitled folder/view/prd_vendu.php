...
$end=$_POST['edate']." 00:00:00";
$reponse = $bdd->query("SELECT * FROM prdcts_vendu WHERE `time`>='$start' AND `time` <='$end' ");
?>
...
<div id="page-wrap">
	...
	<div id="fh5co-hero-wrapper">
		<nav class="container navbar navbar-expand-lg main-navbar-nav navbar-light">
			<a class="navbar-brand" href="admin.php">App( admin mode )</a><a href="prd_vendu1.php">Filter by Seller</a>
