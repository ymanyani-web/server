			...
			<div class='row outer-bottom-sm'>
				<div class='col-md-3 sidebar'>
							...
							<nav class="yamm megamenu-horizontal" role="navigation">
								...
								<ul class="nav">
									<li class="dropdown menu-item">
										...
										?>
											<a href="sub-category.php?scid=<?php echo $row['id']; ?>" class="dropdown-toggle"><i class="icon fa fa-bars fa-fw"></i>
					...
					<div class="sidebar-module-container">
						<h3 class="section-title">magasiner par</h3>
								...
								<div class="caption vertical-top text-left">
									...
									?>
										<div class="excerpt hidden-sm hidden-md">
											<span style="font-family:Marker Felt, fantasy ; color:#b33945;"><?php echo htmlentities($row['categoryName']); ?></span>
										</div>
									<?php } ?>
																	...
																	<ul class="list-unstyled">
																		<li class="add-cart-button btn-group">
																			...
																			<a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
																				<button class="btn btn-primary" type="button">Ajouter au panier</button></a>
