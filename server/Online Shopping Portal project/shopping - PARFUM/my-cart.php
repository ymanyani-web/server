		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-qty item">Quantite</th>
					<th class="cart-sub-total item">Prix ​​par unité</th>
					<th class="cart-sub-total item">Frais de port</th>
					<th class="cart-total last-item">Somme finale</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continuer vos achats</a>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "MAD"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "MAD"." ".$row['shippingCharge']; ?>.00</span></td>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">adresse de livraison</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">adresse de facturation</span>
				</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">PASSER À LA CAISSE</button>
