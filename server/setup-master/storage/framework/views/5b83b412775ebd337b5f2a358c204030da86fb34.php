    ...
    <div class="widget-item card <?php echo e($widget->property('cssClass', 'bg-light')); ?> p-3 shadow-sm">
        <div class="widget-item-action">
            ...
            <a
                ...
                data-toggle="modal"
                data-target="#<?php echo e($widgetAlias); ?>-modal"
...
<?php /**PATH /Users/ymanyani/server/setup-master/app/admin/widgets/dashboardcontainer/widget_item.blade.php ENDPATH**/ ?>