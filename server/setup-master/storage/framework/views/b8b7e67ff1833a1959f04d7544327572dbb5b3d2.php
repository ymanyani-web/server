<?php if (! ($field->hidden)): ?>
    ...
    <?php else: ?>
        ...
        <?php if($field->comment AND $field->commentPosition == 'above'): ?>
            <p class="help-block before-field">
                <?php if($field->commentHtml): ?> <?php echo $field->comment; ?> <?php else: ?> <?php echo app('translator')->get($field->comment); ?> <?php endif; ?>
            </p>
        <?php endif; ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/ymanyani/server/setup-master/app/admin/widgets/form/field.blade.php ENDPATH**/ ?>