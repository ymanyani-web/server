        ...
        <?php if($showCheckboxes): ?>
            <td class="list-action">
                <div class="custom-control custom-checkbox">
                    ...
                    />
                    <label class="custom-control-label" for="<?php echo e('checkbox-'.$record->getKey()); ?>">&nbsp;</label>
                </div>
            </td>
        <?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /Users/ymanyani/server/setup-master/app/admin/widgets/lists/list_body.blade.php ENDPATH**/ ?>