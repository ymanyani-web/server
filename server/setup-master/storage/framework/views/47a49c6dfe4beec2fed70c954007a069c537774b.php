...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu">
        ...
        <a
            ...
            role="button"
        >
            <i class="fa fa-circle fa-fw text-<?php echo e($staffState->getStatusColorName()); ?>"></i>
            <?php echo app('translator')->get('admin::lang.text_set_status'); ?>
        </a>
...
<?php /**PATH /Users/ymanyani/server/setup-master/app/admin/views/_partials/top_nav_user_menu.blade.php ENDPATH**/ ?>